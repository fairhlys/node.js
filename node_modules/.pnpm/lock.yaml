...
packages:
  ...
  express-generator@4.16.1:
    resolution: {integrity: sha512-tWYEx5Y/Llos2qC6yAETmdqEMEPqNUzJ8btGcSZ2zSr8RYOalzffhvh9zx5OQTctvOgJ9kKYxyvFGAIuUuF/wA==}
    engines: {node: '>= 0.10'}
    hasBin: true
  ...
  mongoose@9.2.0:
    resolution: {integrity: sha512-lc1uFbtZHp1FqP8UCzRs9JZLhbBEmDt1l6B2MYmbD07Lp99yppQUwg2yPPyB3NO18EE5nQAoGCRiTf5v6vuJBQ==}
    engines: {node: '>=20.19.0'}
  ...
  sorted-object@2.0.1:
    resolution: {integrity: sha512-oKAAs26HeTu3qbawzUGCkTOBv/5MRrcuJyRWwbfEnWdpXnXsj+WEM3HTvarV73tMcf9uBEZNZoNDVRL62VLxzA==}
